          ...
          <form class="form-horizontal" action="konfirmasitambahbuku.php" method="post" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7"> <select class="form-control" id="penerbit" name="penerbit">
              ...
              <div class="form-group row">
                <label for="tahum_terbit" class="col-sm-3 col-form-label">Tahun Terbit</label>
                <div class="col-sm-7">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-7">
                  ...
                  while ($data_g = mysqli_fetch_row($query_g)) {
                    $id_tg = $data_g[0];
                    $tg = $data_g[1]; ?> <input type="checkbox" name="tag[]" value="<?php echo $id_tg; ?>"> <?php echo $tg; ?>
                    </br>
                  <?php } ?>
                </div>
              </div>
