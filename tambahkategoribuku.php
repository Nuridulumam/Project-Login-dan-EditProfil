    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="kategoribuku.php">Kategori Buku</a></li>
      ...
      <section class="content">
        ...
        <div class="card card-info">
          ...
          <form class="form-horizontal" action="konfirmasitambahkategoribuku.php" method="POST">
            <div class="card-body">
              <div class="form-group row">
                <label for="kategoribuku" class="col-sm-3 col-form-label">Kategori Buku</label>
                <div class="col-sm-7">
                  <input type="text" name="kategori_buku" class="form-control" id="kategoribuku" value="">
                </div>
              </div>
            </div>
            <!-- /.card-body -->
