        ...
        <div class="card card-info">
          ...
          <form class="form-horizontal" method="POST" action="konfirmasieditprofil.php" enctype="multipart/form-data">
            <div class="card-body">
              ...
              <div class="form-group row"> <label for="foto" class="col-sm-3 col-form-label"> Foto Pegawai</label>
                <div class="col-sm-7">
              ...
              <div class="form-group row"> <label for="email" class="col-sm-3 col-form-label">Email</label>
                <div class="col-sm-7"> <input type="text" class="form-control" name="email" id="email" value="<?php echo $email; ?>"> </div>
              </div>
            </div> <!-- /.card-body -->
