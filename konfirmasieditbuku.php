...
if (isset($_SESSION['id_buku'])) {
    ...
    if (empty($id_kategori_buku)) {
        ...
        if (move_uploaded_file($lokasi_file, $direktori)) {
            ...
            $sql = "UPDATE `buku` set `id_kategori_buku`='$id_kategori_buku',`judul`='$judul', `pengarang`='$pengarang',`id_penerbit`='$id_penerbit', `tahun_terbit`='$tahun_terbit',`sinopsis`='$sinopsis', `cover`='$nama_file' WHERE `id_buku`='$id_buku'";
